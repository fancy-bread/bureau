...
- Python 3.14 + LangGraph 0.2+, deepagents, anthropic>=0.25, pydantic>=2, pytest, confluent-kafka (optional) (013-reviewer-hardening-branch-lifecycle)
- SQLite (LangGraph checkpoint), JSON (memory scratchpad) (013-reviewer-hardening-branch-lifecycle)
